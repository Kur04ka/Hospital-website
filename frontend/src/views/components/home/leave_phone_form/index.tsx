...
const LeavePhoneForm = () => {
	...
	const handleSubmit: FormEventHandler<HTMLFormElement> = async e => {
		...
		try {
			...
			await instance.post(
				"call-request/leave-call-request",
				callRequestData,
			);
	...
	return (
		<div className={styles.main}>
			<Typography
				gutterBottom
				variant="h3"
				sx={{ color: "rgba(8, 44, 77, 1)", marginBottom: 3 }}
			>
				Есть вопросы по здоровью?
				<br />
				Специалисты подскажут и помогут!
			</Typography>
			<Typography
				gutterBottom
				variant="h6"
				sx={{ color: "rgba(137, 155, 181, 1)", marginBottom: 6 }}
			>
				Записывайтесь на консультацию в нашу клинику
				<br />
				Вам перезвонят за считанные минуты
			</Typography>
